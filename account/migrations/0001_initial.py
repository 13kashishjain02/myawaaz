    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Pic', models.ImageField(default='/general/titlelogo.png', upload_to=account.models.get_uplaod_file_name)),
                ('DOB', models.DateTimeField(blank=True, null=True)),
                ('Target_competetive_exam', models.CharField(blank=True, max_length=30, null=True)),
                ('Current_education_status', models.CharField(blank=True, max_length=30, null=True)),
                ('Current_city', models.CharField(blank=True, max_length=30, null=True)),
                ('Home_City', models.CharField(blank=True, max_length=30, null=True)),
